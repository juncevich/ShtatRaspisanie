...
namespace ShtatRaspisanie.Entities
{
    public class UnitWithTwoNestedGrade : IUnit
    {
        ...
        public UnitWithTwoNestedGrade(string name, string parent, List<IUnit> child)
        {
            _name = name;
            _parent = parent;
            _child = child;
        ...
        public UnitWithTwoNestedGrade(string name, string parent, List<IUnit> child, List<IStaffUnit> staffUnits)
        {
            _name = name;
            _parent = parent;
            _child = child;
